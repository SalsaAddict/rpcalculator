            ...
            Controller.prototype.$postLink = function () {
                ...
                this.ngModel.$viewChangeListeners.push(function () {
                    ...
                    if (_this.ngModel.$valid) {
                        var nj = (_this.c + 1 < _this.worksheet.competitors.length) ? _this.j : (_this.j + 1) % _this.worksheet.judges.length;
                        var nc = (_this.c + 1) % _this.worksheet.competitors.length;
                        var name_1 = _this.name(nc, nj);
                        var input = document.getElementsByName(name_1)[0];
                        input.focus();
                        input.select();
                    }
                });
